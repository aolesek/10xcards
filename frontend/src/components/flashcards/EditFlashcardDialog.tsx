...
import { updateFlashcard } from "@/lib/api/flashcardsApi";
import { handleApiError } from "@/lib/api/errorParser";
import type { FlashcardResponseDto, FlashcardListItemVm } from "@/lib/flashcards/flashcardTypes";
...
export function EditFlashcardDialog({
  ...
  // Prefill form when flashcard changes or dialog opens
  useEffect(() => {
    if (open && flashcard) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Zmień zawartość przodu lub tyłu fiszki
          </DialogDescription>
        </DialogHeader>
