...
/**
 * AI Generation Mode - strategy for generating flashcards
 */
...
export interface GenerateFlashcardsRequestDto {
  ...
  mode: AIGenerationMode; // Generation mode (knowledge assimilation or language learning)
}
...
/**
 * AI Generation Mode option for select dropdown
 */
export interface AIGenerationModeOptionVm {
